...
local tinyEnginePath = "./"
include(tinyEnginePath .. "Premake/tinyEngineProject")

solution "TinyEngine"
	platforms { "Win32", "x64" }
	configurations { "Debug", "Debug Optimized", "Release", "Final" }

	startproject "TyneEngineApp"
	...
	includeTinyEngine(tinyEnginePath)
	-- projects
	tinyEngineProject ("tinyEngineApp", tinyEnginePath)

		targetname ( "TinyEngine" )
